...
## 📥 Temporary File Downloads  **Download files generated by async tasks when using &#x60;webhook_mode: \&quot;download_url\&quot;&#x60;.**  ### How it works  1. When submitting an async task, set &#x60;webhook_mode: \&quot;download_url\&quot;&#x60; 2. The webhook notification will contain a &#x60;download_url&#x60; instead of base64 content 3. Use this URL to download the file (JWT authentication required) 4. Files expire after 1 hour  ### Security  - JWT authentication required - Only the user who initiated the task can download the file
