...
$apiInstance = new OpenAPI\Client\Api\DownloadsApi(
...
```php
checkFileApiV1DownloadDownloadIdHead_0($download_id): mixed
```
...
try {
    $result = $apiInstance->checkFileApiV1DownloadDownloadIdHead_0($download_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadsApi->checkFileApiV1DownloadDownloadIdHead_0: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
downloadFileApiV1DownloadDownloadIdGet_0($download_id, $delete_after): mixed
```
...
try {
    $result = $apiInstance->downloadFileApiV1DownloadDownloadIdGet_0($download_id, $delete_after);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DownloadsApi->downloadFileApiV1DownloadDownloadIdGet_0: ', $e->getMessage(), PHP_EOL;
}
```
