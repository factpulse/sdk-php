...
------------ | ------------- | ------------- | -------------
**facility_nature** | [**\OpenAPI\Client\Model\AFNORFacilityNature**](AFNORFacilityNature.md) |  |
...
**administrative_status** | [**\OpenAPI\Client\Model\AFNORRoutingCodeAdministrativeStatus**](AFNORRoutingCodeAdministrativeStatus.md) |  |
**address** | [**\OpenAPI\Client\Model\AFNORAddressEdit**](AFNORAddressEdit.md) |  | [optional]
