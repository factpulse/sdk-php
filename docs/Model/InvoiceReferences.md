...
**payment_means** | [**\FactPulse\SDK\Model\PaymentMeans**](PaymentMeans.md) | Payment means type code (BT-81). |
**payment_means_text** | **string** |  | [optional]
**invoice_type** | [**\FactPulse\SDK\Model\InvoiceTypeCode**](InvoiceTypeCode.md) |  |
**vat_accounting_code** | [**\FactPulse\SDK\Model\VATAccountingCode**](VATAccountingCode.md) | VAT accounting code. |
