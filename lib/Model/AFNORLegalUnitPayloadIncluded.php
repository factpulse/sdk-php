...
/**
 * AFNORLegalUnitPayloadIncluded Class Doc Comment
 *
 * @category Class
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 ...
 */
class AFNORLegalUnitPayloadIncluded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_legalUnitPayloadIncluded';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['business_name']) && (mb_strlen($this->container['business_name']) > 150)) {
            $invalidProperties[] = "invalid value for 'business_name', the character length must be smaller than or equal to 150.";
        }
    ...
    public function setSiren($siren)
    {
        ...
        if ((mb_strlen($siren) > 9)) {
            throw new \InvalidArgumentException('invalid length for $siren when calling AFNORLegalUnitPayloadIncluded., must be smaller than or equal to 9.');
        }
        if ((!preg_match("/^([0-9]{9})$/", ObjectSerializer::toString($siren)))) {
            throw new \InvalidArgumentException("invalid value for \$siren when calling AFNORLegalUnitPayloadIncluded., must conform to the pattern /^([0-9]{9})$/.");
        }
    ...
    public function setBusinessName($business_name)
    {
        ...
        if ((mb_strlen($business_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling AFNORLegalUnitPayloadIncluded., must be smaller than or equal to 150.');
        }
