...
/**
 * Destinataire Class Doc Comment
 *
 * @category Class
 ...
 */
class Destinataire implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destinataire';
    ...
    */
    ...
    /**
     * Gets code_service_executant
     *
     * @return string|null
     */
    public function getCodeServiceExecutant()
    {
        return $this->container['code_service_executant'];
    }

    /**
     * Sets code_service_executant
     *
     * @param string|null $code_service_executant code_service_executant
     *
     * @return self
     */
    public function setCodeServiceExecutant($code_service_executant)
    {
        if (is_null($code_service_executant)) {
            array_push($this->openAPINullablesSetToNull, 'code_service_executant');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('code_service_executant', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['code_service_executant'] = $code_service_executant;
