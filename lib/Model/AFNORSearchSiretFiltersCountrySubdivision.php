...
/**
 * AFNORSearchSiretFiltersCountrySubdivision Class Doc Comment
 *
 * @category Class
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 ...
 */
class AFNORSearchSiretFiltersCountrySubdivision implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchSiretFiltersCountrySubdivision';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value Subdivision of the country
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AFNORSearchSiretFiltersCountrySubdivision., must be smaller than or equal to 255.');
        }
