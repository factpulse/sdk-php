...
/**
 * CredentialsChorusPro Class Doc Comment
 *
 * @category Class
 ...
 */
class CredentialsChorusPro implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialsChorusPro';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mode_sandbox', $data ?? [], true);
    }
    ...
    */
     ...
     * Sets mode_sandbox
     *
     * @param bool|null $mode_sandbox [MODE 2] Utiliser le mode sandbox (défaut: True)
     *
     * @return self
     */
    public function setModeSandbox($mode_sandbox)
    {
        if (is_null($mode_sandbox)) {
            throw new \InvalidArgumentException('non-nullable mode_sandbox cannot be null');
        }
