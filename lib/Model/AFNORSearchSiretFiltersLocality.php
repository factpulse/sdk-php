...
/**
 * AFNORSearchSiretFiltersLocality Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AFNORSearchSiretFiltersLocality implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchSiretFiltersLocality';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value Municipality of the recipient structure having defined the directory line(s).
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AFNORSearchSiretFiltersLocality., must be smaller than or equal to 100.');
        }
