...
/**
 * VATEXCodesResponse Class Doc Comment
 *
 * @category Class
 * @description Response for the VATEX codes endpoint.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VATEXCodesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VATEXCodesResponse';
    ...
    protected static $openAPITypes = [
        'codes' => '\FactPulse\SDK\Model\VATEXCodeInfo[]',
        'count' => 'int',
        'source' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('source', $data ?? [], 'https://docs.peppol.eu/poacc/billing/3.0/codelist/vatex/');
    }
    ...
    */
     ...
     * Gets codes
     *
     * @return \FactPulse\SDK\Model\VATEXCodeInfo[]
     */
     ...
     * Sets codes
     *
     * @param \FactPulse\SDK\Model\VATEXCodeInfo[] $codes codes
     *
     * @return self
     */
