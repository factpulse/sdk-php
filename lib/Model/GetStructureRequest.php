...
/**
 * GetStructureRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetStructureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetStructureRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('language_code', $data ?? [], 'fr');
    }
    ...
    */
     ...
     * Sets language_code
     *
     * @param string|null $language_code Language code (fr, en)
     *
     * @return self
     */
