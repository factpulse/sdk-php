...
/**
 * AFNORSearchSiretFiltersName Class Doc Comment
 *
 * @category Class
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 ...
 */
class AFNORSearchSiretFiltersName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchSiretFiltersName';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AFNORSearchSiretFiltersName., must be smaller than or equal to 100.');
        }
