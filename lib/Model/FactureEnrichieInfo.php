...
/**
 * FactureEnrichieInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class FactureEnrichieInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FactureEnrichieInfo';
    ...
    */
    ...
    public function setMontantHtTotal($montant_ht_total)
    {
        ...
        if ((!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($montant_ht_total)))) {
            throw new \InvalidArgumentException("invalid value for \$montant_ht_total when calling FactureEnrichieInfo., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
    ...
    public function setMontantTva($montant_tva)
    {
        ...
        if ((!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($montant_tva)))) {
            throw new \InvalidArgumentException("invalid value for \$montant_tva when calling FactureEnrichieInfo., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
    ...
    public function setMontantTtcTotal($montant_ttc_total)
    {
        ...
        if ((!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($montant_ttc_total)))) {
            throw new \InvalidArgumentException("invalid value for \$montant_ttc_total when calling FactureEnrichieInfo., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
