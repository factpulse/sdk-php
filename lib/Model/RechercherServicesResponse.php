...
/**
 * RechercherServicesResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class RechercherServicesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RechercherServicesResponse';
    ...
    protected static $openAPITypes = [
        'code_retour' => 'int',
        'libelle' => 'string',
        'liste_services' => '\FactPulse\SDK\Model\ServiceStructure[]',
        'total' => 'int'
    ];
    ...
    protected static $setters = [
        ...
        'libelle' => 'setLibelle',
        'liste_services' => 'setListeServices',
        'total' => 'setTotal'
    ];
    ...
    protected static $getters = [
        ...
        'libelle' => 'getLibelle',
        'liste_services' => 'getListeServices',
        'total' => 'getTotal'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('liste_services', $data ?? [], null);
    ...
    */
     ...
     * Gets liste_services
     *
     * @return \FactPulse\SDK\Model\ServiceStructure[]|null
     */
    public function getListeServices()
    {
        return $this->container['liste_services'];
    }

    /**
     * Sets liste_services
     *
     * @param \FactPulse\SDK\Model\ServiceStructure[]|null $liste_services liste_services
     *
     * @return self
     */
    public function setListeServices($liste_services)
    {
        if (is_null($liste_services)) {
            throw new \InvalidArgumentException('non-nullable liste_services cannot be null');
        }
        $this->container['liste_services'] = $liste_services;
     ...
     * Sets total
     *
     * @param int|null $total Nombre de services
     *
     * @return self
     */
