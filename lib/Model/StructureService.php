...
/**
 * StructureService Class Doc Comment
 *
 * @category Class
 ...
 */
class StructureService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StructureService';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('service_label', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['service_label'] === null) {
            $invalidProperties[] = "'service_label' can't be null";
        }
    ...
    {
        return $this->container['service_label'];
    }
    ...
    {
        if (is_null($service_label)) {
            throw new \InvalidArgumentException('non-nullable service_label cannot be null');
        }
        $this->container['service_label'] = $service_label;
     ...
     * Sets is_active
     *
     * @param bool $is_active Service active
     *
     * @return self
     */
