...
class PostalAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $country_subdivision country_subdivision
     *
     * @return self
     */
    public function setCountrySubdivision($country_subdivision)
    {
        if (is_null($country_subdivision)) {
            array_push($this->openAPINullablesSetToNull, 'country_subdivision');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('country_subdivision', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
