...
/**
 * ConvertPendingInputResponse Class Doc Comment
 *
 * @category Class
 * @description Reponse donnees manquantes.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConvertPendingInputResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConvertPendingInputResponse';
    ...
    {
        $this->setIfExists('status', $data ?? [], 'pending_input');
        $this->setIfExists('conversion_id', $data ?? [], null);
        $this->setIfExists('message', $data ?? [], 'Donnees manquantes requises pour la conformite');
    ...
    */
     ...
     * Sets extracted_data
     *
     * @param array<string,mixed> $extracted_data Donnees extraites par OCR au format FacturXInvoice
     *
     * @return self
     */
     ...
     * Gets missing_fields
     *
     * @return \FactPulse\SDK\Model\MissingField[]
     */
     ...
     * Sets missing_fields
     *
     * @param \FactPulse\SDK\Model\MissingField[] $missing_fields missing_fields
     *
     * @return self
     */
     ...
     * Sets resume_url
     *
     * @param string $resume_url resume_url
     *
     * @return self
     */
