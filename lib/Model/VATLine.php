 ...
 */
class VATLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VATLine';
    ...
    protected static $setters = [
        ...
        'rate' => 'setRate',
        'manual_rate' => 'setManualRate',
        'category' => 'setCategory',
        'due_date_type_code' => 'setDueDateTypeCode',
        'exemption_reason' => 'setExemptionReason',
        'vatex_code' => 'setVatexCode'
    ];
    ...
    protected static $getters = [
        ...
        'rate' => 'getRate',
        'manual_rate' => 'getManualRate',
        'category' => 'getCategory',
        'due_date_type_code' => 'getDueDateTypeCode',
        'exemption_reason' => 'getExemptionReason',
        'vatex_code' => 'getVatexCode'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('manual_rate', $data ?? [], null);
        $this->setIfExists('category', $data ?? [], null);
        $this->setIfExists('due_date_type_code', $data ?? [], null);
        $this->setIfExists('exemption_reason', $data ?? [], null);
        $this->setIfExists('vatex_code', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['manual_rate'];
    }
     ...
     * @return self
     */
    public function setManualRate($manual_rate)
    {
        if (is_null($manual_rate)) {
            throw new \InvalidArgumentException('non-nullable manual_rate cannot be null');
        }
        $this->container['manual_rate'] = $manual_rate;
    ...
    {
        return $this->container['due_date_type_code'];
    }
     ...
     * @return self
     */
    public function setDueDateTypeCode($due_date_type_code)
    {
        if (is_null($due_date_type_code)) {
            array_push($this->openAPINullablesSetToNull, 'due_date_type_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('due_date_type_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['due_date_type_code'] = $due_date_type_code;
     ...
     * @return string|null
     */
    public function getVatexCode()
    {
        return $this->container['vatex_code'];
    }

    /**
     * Sets vatex_code
     *
     * @param string|null $vatex_code vatex_code
     *
     * @return self
     */
    public function setVatexCode($vatex_code)
    {
        if (is_null($vatex_code)) {
            array_push($this->openAPINullablesSetToNull, 'vatex_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vatex_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['vatex_code'] = $vatex_code;
