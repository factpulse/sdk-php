...
/**
 * AFNORFlowExtension Class Doc Comment
 *
 * @category Class
 * @description Extension schema to build Flow schema
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AFNORFlowExtension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_FlowExtension';
