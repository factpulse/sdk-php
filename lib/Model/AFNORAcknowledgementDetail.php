 ...
 */
class AFNORAcknowledgementDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_AcknowledgementDetail';
    ...
    */
     ...
     * Sets item
     *
     * @param string $item Item on which the error refers
     *
     * @return self
     */
     ...
     * Sets reason_message
     *
     * @param string $reason_message reason_message
     *
     * @return self
     */
