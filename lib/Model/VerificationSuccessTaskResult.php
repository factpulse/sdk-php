...
/**
 * VerificationSuccessTaskResult Class Doc Comment
 *
 * @category Class
 * @description Successful result from task_verify_pdf.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VerificationSuccessTaskResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationSuccessTaskResult';
