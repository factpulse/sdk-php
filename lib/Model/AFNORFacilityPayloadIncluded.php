 ...
 */
class AFNORFacilityPayloadIncluded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_facilityPayloadIncluded';
    ...
    */
    ...
    public function setSiret($siret)
    {
        ...
        if ((mb_strlen($siret) > 14)) {
            throw new \InvalidArgumentException('invalid length for $siret when calling AFNORFacilityPayloadIncluded., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^([0-9]{14})$/", ObjectSerializer::toString($siret)))) {
            throw new \InvalidArgumentException("invalid value for \$siret when calling AFNORFacilityPayloadIncluded., must conform to the pattern /^([0-9]{14})$/.");
        }
    ...
    public function setSiren($siren)
    {
        ...
        if ((mb_strlen($siren) > 9)) {
            throw new \InvalidArgumentException('invalid length for $siren when calling AFNORFacilityPayloadIncluded., must be smaller than or equal to 9.');
        }
        if ((!preg_match("/^([0-9]{9})$/", ObjectSerializer::toString($siren)))) {
            throw new \InvalidArgumentException("invalid value for \$siren when calling AFNORFacilityPayloadIncluded., must conform to the pattern /^([0-9]{9})$/.");
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AFNORFacilityPayloadIncluded., must be smaller than or equal to 100.');
        }
