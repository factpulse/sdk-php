 ...
 */
class AggregatedPaymentInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AggregatedPaymentInput';
    ...
    */
    ...
    public function setAmountsByRate($amounts_by_rate)
    {
        ...
        if ((count($amounts_by_rate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $amounts_by_rate when calling AggregatedPaymentInput., number of items must be greater than or equal to 1.');
        }
