...
/**
 * SecretStatus Class Doc Comment
 *
 * @category Class
 * @description Secret status (never exposes the secret itself).
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SecretStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecretStatus';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Secret status: 'active', 'missing', etc.
     *
     * @return self
     */
