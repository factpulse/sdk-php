 ...
 */
class AFNORRoutingCodeSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_routingCodeSearch';
    ...
    public const MODEL_INCLUDE_SIREN = 'siren';
    public const MODEL_INCLUDE_SIRET = 'siret';
    ...
    {
        return [
            self::MODEL_INCLUDE_SIREN,
            self::MODEL_INCLUDE_SIRET,
        ];
    }
