 ...
 */
class TaxRepresentative implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxRepresentative';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Tax representative name (BT-62).
     *
     * @return self
     */
     ...
     * Sets vat_number
     *
     * @param string $vat_number Tax representative VAT identifier (BT-63).
     *
     * @return self
     */
