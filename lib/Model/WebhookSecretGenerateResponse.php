...
/**
 * WebhookSecretGenerateResponse Class Doc Comment
 *
 * @category Class
 * @description Response after generating a webhook secret.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WebhookSecretGenerateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookSecretGenerateResponse';
    ...
    */
     ...
     * Sets success
     *
     * @param bool $success Whether the secret was generated successfully
     *
     * @return self
     */
     ...
     * Sets webhook_secret
     *
     * @param string $webhook_secret The generated webhook secret (save it, it will never be shown again)
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at When the secret was created
     *
     * @return self
     */
