 ...
 */
class AFNORSearchSiretSortingInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchSiretSortingInner';
