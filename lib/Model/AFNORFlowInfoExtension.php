...
/**
 * AFNORFlowInfoExtension Class Doc Comment
 *
 * @category Class
 * @description Extension to build the FlowInfo
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AFNORFlowInfoExtension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_FlowInfoExtension';
    ...
    */
    ...
    public function setSha256($sha256)
    {
        ...
        if ((!preg_match("/^[a-f0-9]{64}$/", ObjectSerializer::toString($sha256)))) {
            throw new \InvalidArgumentException("invalid value for \$sha256 when calling AFNORFlowInfoExtension., must conform to the pattern /^[a-f0-9]{64}$/.");
        }
