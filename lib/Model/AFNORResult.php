 ...
 */
class AFNORResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNORResult';
    ...
    protected static array $openAPINullables = [
        ...
        'flow_profile' => true,
        'flow_type' => true,
        'processing_rule' => true,
        'processing_rule_source' => true
    ];
    ...
    */
     ...
     * Sets flow_id
     *
     * @param string $flow_id Submitted flow identifier
     *
     * @return self
     */
     ...
     * Sets sha256
     *
     * @param string $sha256 SHA-256 hash of submitted file
     *
     * @return self
     */
     ...
     * Sets flow_syntax
     *
     * @param string $flow_syntax Flow syntax
     *
     * @return self
     */
     ...
     *
     * @param string|null $processing_rule processing_rule
     *
     * @return self
     */
    public function setProcessingRule($processing_rule)
    {
        if (is_null($processing_rule)) {
            array_push($this->openAPINullablesSetToNull, 'processing_rule');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('processing_rule', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $processing_rule_source processing_rule_source
     *
     * @return self
     */
    public function setProcessingRuleSource($processing_rule_source)
    {
        if (is_null($processing_rule_source)) {
            array_push($this->openAPINullablesSetToNull, 'processing_rule_source');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('processing_rule_source', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
