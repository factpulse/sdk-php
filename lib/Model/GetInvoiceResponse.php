...
class GetInvoiceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'return_code' => false,
        'message' => false,
        'chorus_invoice_id' => true,
        'invoice_number' => true,
        'invoice_date' => true,
        'total_gross_amount' => true,
        'current_status' => true,
        'recipient_structure_id' => true,
        'recipient_structure_name' => true
    ];
    ...
    protected static $setters = [
        ...
        'message' => 'setMessage',
        'chorus_invoice_id' => 'setChorusInvoiceId',
        'invoice_number' => 'setInvoiceNumber',
        'invoice_date' => 'setInvoiceDate',
        'total_gross_amount' => 'setTotalGrossAmount',
        'current_status' => 'setCurrentStatus',
        'recipient_structure_id' => 'setRecipientStructureId',
        'recipient_structure_name' => 'setRecipientStructureName'
    ];
    ...
    protected static $getters = [
        ...
        'message' => 'getMessage',
        'chorus_invoice_id' => 'getChorusInvoiceId',
        'invoice_number' => 'getInvoiceNumber',
        'invoice_date' => 'getInvoiceDate',
        'total_gross_amount' => 'getTotalGrossAmount',
        'current_status' => 'getCurrentStatus',
        'recipient_structure_id' => 'getRecipientStructureId',
        'recipient_structure_name' => 'getRecipientStructureName'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('chorus_invoice_id', $data ?? [], null);
        ...
        $this->setIfExists('recipient_structure_id', $data ?? [], null);
        $this->setIfExists('recipient_structure_name', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets chorus_invoice_id
     *
     * @return int|null
     */
    public function getChorusInvoiceId()
    {
        return $this->container['chorus_invoice_id'];
    }

    /**
     * Sets chorus_invoice_id
     *
     * @param int|null $chorus_invoice_id chorus_invoice_id
     *
     * @return self
     */
    public function setChorusInvoiceId($chorus_invoice_id)
    {
        if (is_null($chorus_invoice_id)) {
            array_push($this->openAPINullablesSetToNull, 'chorus_invoice_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('chorus_invoice_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['chorus_invoice_id'] = $chorus_invoice_id;
    ...
    /**
     * Gets recipient_structure_id
     *
     * @return int|null
     */
    public function getRecipientStructureId()
    {
        return $this->container['recipient_structure_id'];
    }

    /**
     * Sets recipient_structure_id
     *
     * @param int|null $recipient_structure_id recipient_structure_id
     *
     * @return self
     */
    public function setRecipientStructureId($recipient_structure_id)
    {
        if (is_null($recipient_structure_id)) {
            array_push($this->openAPINullablesSetToNull, 'recipient_structure_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recipient_structure_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['recipient_structure_id'] = $recipient_structure_id;

        return $this;
    }

    /**
     * Gets recipient_structure_name
     *
     * @return string|null
     */
    public function getRecipientStructureName()
    {
        return $this->container['recipient_structure_name'];
    }

    /**
     * Sets recipient_structure_name
     *
     * @param string|null $recipient_structure_name recipient_structure_name
     *
     * @return self
     */
    public function setRecipientStructureName($recipient_structure_name)
    {
        if (is_null($recipient_structure_name)) {
            array_push($this->openAPINullablesSetToNull, 'recipient_structure_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recipient_structure_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['recipient_structure_name'] = $recipient_structure_name;
