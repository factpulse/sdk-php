 ...
 *
 * @category Class
 * @description Partial client update request.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ClientUpdateRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ClientUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ClientUpdateRequest., must be smaller than or equal to 1000.');
        }
    ...
    public function setSiret($siret)
    {
        ...
        if (!is_null($siret) && (!preg_match("/^\\d{14}$/", ObjectSerializer::toString($siret)))) {
            throw new \InvalidArgumentException("invalid value for \$siret when calling ClientUpdateRequest., must conform to the pattern /^\\d{14}$/.");
        }
