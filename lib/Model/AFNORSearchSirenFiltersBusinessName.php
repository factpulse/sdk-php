...
/**
 * AFNORSearchSirenFiltersBusinessName Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AFNORSearchSirenFiltersBusinessName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchSirenFiltersBusinessName';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value Business name
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 150)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AFNORSearchSirenFiltersBusinessName., must be smaller than or equal to 150.');
        }
