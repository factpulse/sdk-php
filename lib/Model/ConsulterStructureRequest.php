...
/**
 * ConsulterStructureRequest Class Doc Comment
 *
 * @category Class
 * @description Consulter les détails d&#39;une structure.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConsulterStructureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsulterStructureRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('code_langue', $data ?? [], 'fr');
    }
    ...
    */
    ...
    {
        return $this->container['code_langue'];
    }

    /**
     * Sets code_langue
     *
     * @param string|null $code_langue Code langue (fr, en)
     *
     * @return self
     */
    public function setCodeLangue($code_langue)
    {
        if (is_null($code_langue)) {
            throw new \InvalidArgumentException('non-nullable code_langue cannot be null');
        }
        $this->container['code_langue'] = $code_langue;
