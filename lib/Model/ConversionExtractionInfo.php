...
/**
 * ConversionExtractionInfo Class Doc Comment
 *
 * @category Class
 * @description OCR extraction metadata.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConversionExtractionInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversionExtractionInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ocr_provider', $data ?? [], 'mistral_ocr');
    }
    ...
    */
    ...
    {
        return $this->container['ocr_provider'];
    }

    /**
     * Sets ocr_provider
     *
     * @param string|null $ocr_provider ocr_provider
     *
     * @return self
     */
    public function setOcrProvider($ocr_provider)
    {
        if (is_null($ocr_provider)) {
            throw new \InvalidArgumentException('non-nullable ocr_provider cannot be null');
        }
        $this->container['ocr_provider'] = $ocr_provider;
