 ...
 */
class SubmitCompleteInvoiceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitCompleteInvoiceResponse';
    ...
    */
     ...
     * Sets success
     *
     * @param bool $success Invoice was successfully submitted
     *
     * @return self
     */
    ...
    {
        return $this->container['chorus_result'];
    }
     ...
     * @return self
     */
    public function setChorusResult($chorus_result)
    {
        if (is_null($chorus_result)) {
            array_push($this->openAPINullablesSetToNull, 'chorus_result');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('chorus_result', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['chorus_result'] = $chorus_result;
    ...
    {
        return $this->container['afnor_result'];
    }
     ...
     * @return self
     */
    public function setAfnorResult($afnor_result)
    {
        if (is_null($afnor_result)) {
            array_push($this->openAPINullablesSetToNull, 'afnor_result');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('afnor_result', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['afnor_result'] = $afnor_result;
    ...
    {
        return $this->container['enriched_invoice'];
    }
     ...
     * @return self
     */
    public function setEnrichedInvoice($enriched_invoice)
    {
        if (is_null($enriched_invoice)) {
    ...
    {
        return $this->container['facturx_pdf'];
    }
     ...
     * @return self
     */
    public function setFacturxPdf($facturx_pdf)
    {
        if (is_null($facturx_pdf)) {
            throw new \InvalidArgumentException('non-nullable facturx_pdf cannot be null');
        }
        $this->container['facturx_pdf'] = $facturx_pdf;
