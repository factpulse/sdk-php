 ...
 */
class CreateAggregatedReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAggregatedReportRequest';
    ...
    protected static $setters = [
        ...
        'transaction_payments' => 'setTransactionPayments'
    ];
    ...
    protected static $getters = [
        ...
        'transaction_payments' => 'getTransactionPayments'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('transaction_payments', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['transaction_payments'];
    }
     ...
     * @return self
     */
    public function setTransactionPayments($transaction_payments)
    {
        if (is_null($transaction_payments)) {
            array_push($this->openAPINullablesSetToNull, 'transaction_payments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transaction_payments', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['transaction_payments'] = $transaction_payments;
