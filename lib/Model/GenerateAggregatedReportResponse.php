...
/**
 * GenerateAggregatedReportResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateAggregatedReportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateAggregatedReportResponse';
    ...
    protected static $openAPITypes = [
        ...
        'xml' => 'string',
        'xml_size' => 'int',
        'content_summary' => 'array<string,mixed>',
        'message' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('xml_size', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transmission_type'] === null) {
            $invalidProperties[] = "'transmission_type' can't be null";
        }
        ...
        if ($this->container['xml_size'] === null) {
            $invalidProperties[] = "'xml_size' can't be null";
        }
        if ($this->container['content_summary'] === null) {
            $invalidProperties[] = "'content_summary' can't be null";
        }
     ...
     *
     * @param string $transmission_type Transmission type (IN or RE)
     *
     * @return self
     */
     ...
     * Sets flow_type
     *
     * @param string $flow_type AFNOR FlowType determined from content
     *
     * @return self
     */
    ...
    {
        return $this->container['xml_size'];
    }

    /**
     * Sets xml_size
     *
     * @param int $xml_size XML size in bytes
     *
     * @return self
     */
    public function setXmlSize($xml_size)
    {
        if (is_null($xml_size)) {
            throw new \InvalidArgumentException('non-nullable xml_size cannot be null');
        }
        $this->container['xml_size'] = $xml_size;
     ...
     *
     * @param array<string,mixed> $content_summary Summary of content (counts by flux type)
     *
     * @return self
     */
