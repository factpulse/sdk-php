...
/**
 * AFNORCoreFlowInfo Class Doc Comment
 *
 * @category Class
 * @description Core schema to build FlowInfo, FullFlowInfo, Flow schemas
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AFNORCoreFlowInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_CoreFlowInfo';
    ...
    */
    ...
    public function setTrackingId($tracking_id)
    {
        ...
        if ((mb_strlen($tracking_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling AFNORCoreFlowInfo., must be smaller than or equal to 36.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AFNORCoreFlowInfo., must be smaller than or equal to 255.');
        }
