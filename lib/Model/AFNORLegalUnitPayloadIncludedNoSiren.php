 ...
 */
class AFNORLegalUnitPayloadIncludedNoSiren implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_legalUnitPayloadIncludedNoSiren';
    ...
    */
    ...
    public function setBusinessName($business_name)
    {
        ...
        if ((mb_strlen($business_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling AFNORLegalUnitPayloadIncludedNoSiren., must be smaller than or equal to 150.');
        }
