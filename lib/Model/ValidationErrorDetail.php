 ...
 *
 * @category Class
 * @description Détail d&#39;une erreur de validation (aligné sur AFNOR AcknowledgementDetail).  Format unifié pour toutes les erreurs de validation Factur-X, compatible avec la norme AFNOR XP Z12-013.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ValidationErrorDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets level
     *
     * @param \FactPulse\SDK\Model\ErrorLevel|null $level Niveau de gravité : 'Error' ou 'Warning'
     *
     * @return self
     */
     ...
     * Sets item
     *
     * @param string $item Identifiant de l'élément concerné (XPath, champ, règle BR-FR, etc.)
     *
     * @return self
     */
