 ...
 */
class AFNORSearchDirectoryLineFiltersAddressingSuffix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchDirectoryLineFiltersAddressingSuffix';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value suffix of the directory line which defines an address mesh not attached to a facility
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AFNORSearchDirectoryLineFiltersAddressingSuffix., must be smaller than or equal to 100.');
        }
