...
/**
 * AFNORLegalUnitPayloadHistory Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AFNORLegalUnitPayloadHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_legalUnitPayloadHistory';
    ...
    */
    ...
    public function setSiren($siren)
    {
        ...
        if ((mb_strlen($siren) > 9)) {
            throw new \InvalidArgumentException('invalid length for $siren when calling AFNORLegalUnitPayloadHistory., must be smaller than or equal to 9.');
        }
        if ((!preg_match("/^([0-9]{9})$/", ObjectSerializer::toString($siren)))) {
            throw new \InvalidArgumentException("invalid value for \$siren when calling AFNORLegalUnitPayloadHistory., must conform to the pattern /^([0-9]{9})$/.");
        }
    ...
    public function setBusinessName($business_name)
    {
        ...
        if ((mb_strlen($business_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling AFNORLegalUnitPayloadHistory., must be smaller than or equal to 150.');
        }
