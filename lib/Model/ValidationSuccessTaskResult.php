...
/**
 * ValidationSuccessTaskResult Class Doc Comment
 *
 * @category Class
 * @description Successful result from task_validate_facturx_pdf.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ValidationSuccessTaskResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidationSuccessTaskResult';
