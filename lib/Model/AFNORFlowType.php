...
/**
 * AFNORFlowType Class Doc Comment
 *
 * @category Class
...
class AFNORFlowType
{
    ...
    public const STATE_INVOICE = 'StateInvoice';

    public const CUSTOMER_INVOICE_LC = 'CustomerInvoiceLC';

    public const SUPPLIER_INVOICE_LC = 'SupplierInvoiceLC';

    public const STATE_CUSTOMER_INVOICE_LC = 'StateCustomerInvoiceLC';

    public const STATE_SUPPLIER_INVOICE_LC = 'StateSupplierInvoiceLC';

    public const AGGREGATED_CUSTOMER_TRANSACTION_REPORT = 'AggregatedCustomerTransactionReport';

    public const UNITARY_CUSTOMER_TRANSACTION_REPORT = 'UnitaryCustomerTransactionReport';

    public const AGGREGATED_CUSTOMER_PAYMENT_REPORT = 'AggregatedCustomerPaymentReport';

    public const UNITARY_CUSTOMER_PAYMENT_REPORT = 'UnitaryCustomerPaymentReport';

    public const UNITARY_SUPPLIER_TRANSACTION_REPORT = 'UnitarySupplierTransactionReport';

    public const MULTI_FLOW_REPORT = 'MultiFlowReport';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::STATE_CUSTOMER_INVOICE_LC,
            self::STATE_SUPPLIER_INVOICE_LC,
            self::AGGREGATED_CUSTOMER_TRANSACTION_REPORT,
            self::UNITARY_CUSTOMER_TRANSACTION_REPORT,
            self::AGGREGATED_CUSTOMER_PAYMENT_REPORT,
            self::UNITARY_CUSTOMER_PAYMENT_REPORT,
            self::UNITARY_SUPPLIER_TRANSACTION_REPORT,
            self::MULTI_FLOW_REPORT
        ];
    }
}
