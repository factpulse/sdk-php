 ...
 */
class AFNORSearchSirenFiltersEntityType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchSirenFiltersEntityType';
