 ...
 */
class InvoicePaymentInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicePaymentInput';
    ...
    protected static $setters = [
        ...
        'amounts_by_rate' => 'setAmountsByRate'
    ];
    ...
    protected static $getters = [
        ...
        'amounts_by_rate' => 'getAmountsByRate'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('amounts_by_rate', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['amounts_by_rate'] === null) {
            $invalidProperties[] = "'amounts_by_rate' can't be null";
        }
        if ((count($this->container['amounts_by_rate']) < 1)) {
            $invalidProperties[] = "invalid value for 'amounts_by_rate', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets invoice_date
     *
     * @param \DateTime $invoice_date Original invoice date
     *
     * @return self
     */
    ...
    {
        return $this->container['amounts_by_rate'];
    }
     ...
     * @return self
     */
    public function setAmountsByRate($amounts_by_rate)
    {
        if (is_null($amounts_by_rate)) {
            throw new \InvalidArgumentException('non-nullable amounts_by_rate cannot be null');
        }


        if ((count($amounts_by_rate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $amounts_by_rate when calling InvoicePaymentInput., number of items must be greater than or equal to 1.');
        }
        $this->container['amounts_by_rate'] = $amounts_by_rate;
