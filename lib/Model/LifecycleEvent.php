 ...
 *
 * @category Class
 * @description Evenement de cycle de vie d&#39;une facture.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LifecycleEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'issuer_siren' => 'setIssuerSiren',
        'issuer_role' => 'setIssuerRole',
    ...
    protected static $getters = [
        ...
        'issuer_siren' => 'getIssuerSiren',
        'issuer_role' => 'getIssuerRole',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('issuer_siren', $data ?? [], null);
        $this->setIfExists('issuer_role', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['amount']) && !preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", $this->container['amount'])) {
            $invalidProperties[] = "invalid value for 'amount', must be conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.";
        }
     ...
     * Sets flow_id
     *
     * @param string $flow_id ID du flux lifecycle
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param string $status_code Code statut (200-601)
     *
     * @return self
     */
     ...
     * Sets ack_status
     *
     * @param string|null $ack_status ack_status
     *
     * @return self
     */
    public function setAckStatus($ack_status)
    {
        if (is_null($ack_status)) {
            array_push($this->openAPINullablesSetToNull, 'ack_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ack_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($at)) {
            array_push($this->openAPINullablesSetToNull, 'at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && (!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling LifecycleEvent., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
     ...
     * @return string|null
     */
    public function getIssuerSiren()
    {
        return $this->container['issuer_siren'];
    }

    /**
     * Sets issuer_siren
     *
     * @param string|null $issuer_siren issuer_siren
     *
     * @return self
     */
    public function setIssuerSiren($issuer_siren)
    {
        if (is_null($issuer_siren)) {
            array_push($this->openAPINullablesSetToNull, 'issuer_siren');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('issuer_siren', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['issuer_siren'] = $issuer_siren;
    ...
    {
        return $this->container['issuer_role'];
    }

    /**
     * Sets issuer_role
     *
     * @param string|null $issuer_role issuer_role
     *
     * @return self
     */
    public function setIssuerRole($issuer_role)
    {
        if (is_null($issuer_role)) {
            array_push($this->openAPINullablesSetToNull, 'issuer_role');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('issuer_role', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['issuer_role'] = $issuer_role;
