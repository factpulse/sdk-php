...
/**
 * StatutFacture Class Doc Comment
 *
 * @category Class
 ...
 */
class StatutFacture implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatutFacture';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Code statut (SOUMISE, VALIDEE, REJETEE, SUSPENDUE, MANDATEE, MISE_EN_PAIEMENT, etc.)
     *
     * @return self
     */
     ...
     * Sets libelle
     *
     * @param string $libelle Libellé du statut
     *
     * @return self
     */
