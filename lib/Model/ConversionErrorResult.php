...
/**
 * ConversionErrorResult Class Doc Comment
 *
 * @category Class
 * @description Error result specific to conversion tasks.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConversionErrorResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversionErrorResult';
    ...
    */
    ...
    public function setConversionId($conversion_id)
    {
        if (is_null($conversion_id)) {
            array_push($this->openAPINullablesSetToNull, 'conversion_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('conversion_id', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setTraceback($traceback)
    {
        if (is_null($traceback)) {
            array_push($this->openAPINullablesSetToNull, 'traceback');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('traceback', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setProcessingTimeMs($processing_time_ms)
    {
        if (is_null($processing_time_ms)) {
            array_push($this->openAPINullablesSetToNull, 'processing_time_ms');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('processing_time_ms', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
