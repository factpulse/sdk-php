...
/**
 * AFNORFullFlowInfoExtension Class Doc Comment
 *
 * @category Class
 * @description Extension schema to build FFullFlowInfo, Flow schemas
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AFNORFullFlowInfoExtension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_FullFlowInfoExtension';
    ...
    */
    ...
    public function setFlowId($flow_id)
    {
        ...
        if ((mb_strlen($flow_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $flow_id when calling AFNORFullFlowInfoExtension., must be smaller than or equal to 36.');
        }
