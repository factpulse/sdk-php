 ...
 */
class IncomingSupplier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncomingSupplier';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Supplier business name (BT-27)
     *
     * @return self
     */
