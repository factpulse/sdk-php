 ...
 */
class SubmitCompleteInvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitCompleteInvoiceRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('source_pdf', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['source_pdf'] === null) {
            $invalidProperties[] = "'source_pdf' can't be null";
        }
    ...
    {
        return $this->container['source_pdf'];
    }

    /**
     * Sets source_pdf
     *
     * @param string $source_pdf Base64-encoded source PDF (will be transformed to Factur-X)
     *
     * @return self
     */
    public function setSourcePdf($source_pdf)
    {
        if (is_null($source_pdf)) {
            throw new \InvalidArgumentException('non-nullable source_pdf cannot be null');
        }
        $this->container['source_pdf'] = $source_pdf;
