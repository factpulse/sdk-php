 ...
 */
class ConvertResumeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConvertResumeRequest';
    ...
    */
     ...
     * Sets overrides
     *
     * @param array<string,mixed>|null $overrides Sous-ensemble de FacturXInvoice a mettre a jour (merge profond)
     *
     * @return self
     */
