...
/**
 * AFNORFullFlowInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class AFNORFullFlowInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_FullFlowInfo';
    ...
    */
    ...
    public function setTrackingId($tracking_id)
    {
        ...
        if ((mb_strlen($tracking_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling AFNORFullFlowInfo., must be smaller than or equal to 36.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AFNORFullFlowInfo., must be smaller than or equal to 255.');
        }
    ...
    public function setSha256($sha256)
    {
        ...
        if ((!preg_match("/^[a-f0-9]{64}$/", ObjectSerializer::toString($sha256)))) {
            throw new \InvalidArgumentException("invalid value for \$sha256 when calling AFNORFullFlowInfo., must conform to the pattern /^[a-f0-9]{64}$/.");
        }
