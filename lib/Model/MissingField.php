...
/**
 * MissingField Class Doc Comment
 *
 * @category Class
 ...
 */
class MissingField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MissingField';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('required_for', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bt_code'] === null) {
            $invalidProperties[] = "'bt_code' can't be null";
        }
        if ($this->container['description'] === null) {
            $invalidProperties[] = "'description' can't be null";
        }
        if ($this->container['required_for'] === null) {
            $invalidProperties[] = "'required_for' can't be null";
        }
     ...
     * Sets bt_code
     *
     * @param string $bt_code Code Business Term (BT-XX)
     *
     * @return self
     */
    ...
    {
        if (is_null($bt_code)) {
            throw new \InvalidArgumentException('non-nullable bt_code cannot be null');
        }
     ...
     * Sets required_for
     *
     * @param string[] $required_for Profils necessitant ce champ
     *
     * @return self
     */
    public function setRequiredFor($required_for)
    {
        if (is_null($required_for)) {
            throw new \InvalidArgumentException('non-nullable required_for cannot be null');
        }
