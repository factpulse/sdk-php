 ...
 *
 * @category Class
 * @description Erreur API standardisée (alignée sur AFNOR Error schema).  Format unifié pour toutes les réponses d&#39;erreur HTTP.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class APIError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets error_code
     *
     * @param string $error_code Code alphanumérique identifiant précisément l'erreur
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string $error_message Message décrivant l'erreur (non destiné à l'utilisateur final)
     *
     * @return self
     */
