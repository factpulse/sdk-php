...
class APIError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets error_code
     *
     * @param string $error_code Alphanumeric code precisely identifying the error
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string $error_message Message describing the error (not intended for end user)
     *
     * @return self
     */
