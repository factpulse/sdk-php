...
/**
 * AdditionalDocument Class Doc Comment
 *
 * @category Class
 * @description Additional supporting document (BG-24).  References to external documents or embedded attachments.
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdditionalDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdditionalDocument';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('reference_type_code', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Document reference identifier (BT-122).
     *
     * @return self
     */
     ...
     *
     * @param string|null $reference_type_code reference_type_code
     *
     * @return self
     */
    public function setReferenceTypeCode($reference_type_code)
    {
        if (is_null($reference_type_code)) {
            array_push($this->openAPINullablesSetToNull, 'reference_type_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reference_type_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
