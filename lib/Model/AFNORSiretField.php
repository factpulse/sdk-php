...
/**
 * AFNORSiretField Class Doc Comment
 *
 * @category Class
...
class AFNORSiretField
{
    ...
    public const PM_ONLY = 'pmOnly';

    public const MANAGES_PAYMENT_STATUS = 'managesPaymentStatus';

    public const MANAGES_LEGAL_COMMITMENT = 'managesLegalCommitment';

    public const MANAGES_LEGAL_COMMITMENT_OR_SERVICE = 'managesLegalCommitmentOrService';
