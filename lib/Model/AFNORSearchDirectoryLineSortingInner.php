 ...
 */
class AFNORSearchDirectoryLineSortingInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_searchDirectoryLineSortingInner';
