...
/**
 * GetChorusProIdRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GetChorusProIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetChorusProIdRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('identifier_type', $data ?? [], 'SIRET');
    }
    ...
    */
     ...
     * Sets siret
     *
     * @param string $siret Structure SIRET (14 digits)
     *
     * @return self
     */
     ...
     *
     * @param string|null $identifier_type Identifier type (SIRET, SIREN, UE_HORS_FRANCE, etc.)
     *
     * @return self
     */
