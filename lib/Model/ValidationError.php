...
class ValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'loc' => '\FactPulse\SDK\Model\ValidationErrorLocInner[]',
        'msg' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets loc
     *
     * @return \FactPulse\SDK\Model\ValidationErrorLocInner[]
     */
     ...
     * Sets loc
     *
     * @param \FactPulse\SDK\Model\ValidationErrorLocInner[] $loc loc
     *
     * @return self
     */
