...
class SoumettreFactureCompleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \FactPulse\SDK\Model\DonneesFactureSimplifiees $donnees_facture Données de la facture au format simplifié (voir exemples)
     *
     * @return self
     */
     ...
     * Sets pdf_source
     *
     * @param string $pdf_source PDF source encodé en base64 (sera transformé en Factur-X)
     *
     * @return self
     */
