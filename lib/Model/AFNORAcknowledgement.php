 ...
 */
class AFNORAcknowledgement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_Acknowledgement';
    ...
    */
    ...
    public function setDetails($details)
    {
        ...
        if ((count($details) < 1)) {
            throw new \InvalidArgumentException('invalid length for $details when calling AFNORAcknowledgement., number of items must be greater than or equal to 1.');
        }
