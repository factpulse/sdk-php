 ...
 *
 * @category Class
 * @description PDP credentials for zero-storage strategy (Strategy B).  Allows providing PDP credentials directly in the request instead of storing them in Django.  Useful for: - Ad-hoc tests without persisting credentials - Temporary integrations - Development environments
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PDPCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $flow_service_url Base URL of the AFNOR Flow Service
     *
     * @return self
     */
     ...
     * Sets token_url
     *
     * @param string $token_url OAuth2 server URL
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret OAuth2 Client Secret (sensitive)
     *
     * @return self
     */
