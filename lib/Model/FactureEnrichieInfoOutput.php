...
/**
 * FactureEnrichieInfoOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class FactureEnrichieInfoOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FactureEnrichieInfo-Output';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", $this->container['montant_ht_total'])) {
            $invalidProperties[] = "invalid value for 'montant_ht_total', must be conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.";
        }
        ...
        if (!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", $this->container['montant_ttc_total'])) {
            $invalidProperties[] = "invalid value for 'montant_ttc_total', must be conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.";
        }
     ...
     *
     * @param string $montant_ht_total montant_ht_total
     *
     * @return self
     */
    public function setMontantHtTotal($montant_ht_total)
    {
        ...
        if ((!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($montant_ht_total)))) {
            throw new \InvalidArgumentException("invalid value for \$montant_ht_total when calling FactureEnrichieInfoOutput., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
     ...
     * Sets montant_tva
     *
     * @param string $montant_tva montant_tva
     *
     * @return self
     */
    public function setMontantTva($montant_tva)
    {
        ...
        if ((!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($montant_tva)))) {
            throw new \InvalidArgumentException("invalid value for \$montant_tva when calling FactureEnrichieInfoOutput., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
     ...
     *
     * @param string $montant_ttc_total montant_ttc_total
     *
     * @return self
     */
    public function setMontantTtcTotal($montant_ttc_total)
    {
        ...
        if ((!preg_match("/^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/", ObjectSerializer::toString($montant_ttc_total)))) {
            throw new \InvalidArgumentException("invalid value for \$montant_ttc_total when calling FactureEnrichieInfoOutput., must conform to the pattern /^(?!^[-+.]*$)[+-]?0*\\d*\\.?\\d*$/.");
        }
