...
/**
 * AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode Class Doc Comment
 *
 * @category Class
 * @package  FactPulse\SDK
 * @author   OpenAPI Generator team
 ...
 */
class AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AFNOR_directoryLinePayloadLegalUnitFacilityRoutingCode';
    ...
    */
    ...
    public function setAddressingIdentifier($addressing_identifier)
    {
        ...
        if ((mb_strlen($addressing_identifier) > 125)) {
            throw new \InvalidArgumentException('invalid length for $addressing_identifier when calling AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode., must be smaller than or equal to 125.');
        }
    ...
    public function setSiren($siren)
    {
        ...
        if ((mb_strlen($siren) > 9)) {
            throw new \InvalidArgumentException('invalid length for $siren when calling AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode., must be smaller than or equal to 9.');
        }
        if ((!preg_match("/^([0-9]{9})$/", ObjectSerializer::toString($siren)))) {
            throw new \InvalidArgumentException("invalid value for \$siren when calling AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode., must conform to the pattern /^([0-9]{9})$/.");
        }
    ...
    public function setSiret($siret)
    {
        ...
        if ((mb_strlen($siret) > 14)) {
            throw new \InvalidArgumentException('invalid length for $siret when calling AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^([0-9]{14})$/", ObjectSerializer::toString($siret)))) {
            throw new \InvalidArgumentException("invalid value for \$siret when calling AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode., must conform to the pattern /^([0-9]{14})$/.");
        }
    ...
    public function setAddressingSuffix($addressing_suffix)
    {
        ...
        if ((mb_strlen($addressing_suffix) > 100)) {
            throw new \InvalidArgumentException('invalid length for $addressing_suffix when calling AFNORDirectoryLinePayloadLegalUnitFacilityRoutingCode., must be smaller than or equal to 100.');
        }
