...
/**
 * SubmitFlowResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SubmitFlowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitFlowResponse';
    ...
    */
     ...
     * Sets flow_id
     *
     * @param string $flow_id Unique flow identifier generated by the PDP
     *
     * @return self
     */
     ...
     * Sets flow_syntax
     *
     * @param string $flow_syntax Flow syntax (CII, UBL, etc.)
     *
     * @return self
     */
     ...
     * Sets sha256
     *
     * @param string $sha256 SHA256 hash of the submitted file
     *
     * @return self
     */
