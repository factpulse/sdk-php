 ...
 */
class FilesInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilesInfo';
    ...
    */
    ...
    public function setFacturxPdf($facturx_pdf)
    {
        if (is_null($facturx_pdf)) {
            array_push($this->openAPINullablesSetToNull, 'facturx_pdf');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('facturx_pdf', $nullablesSetToNull);
            if ($index !== FALSE) {
